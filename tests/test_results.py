...
def test_splicing_outlier_result_predict_absplice_dna_matches_pkl():
    ...
    original_result = sor.predict_absplice_dna(pickle_file="absplice/precomputed/AbSplice_DNA.pkl")
    onnx_result = sor.predict_absplice_dna(pickle_file="absplice/precomputed/AbSplice_DNA.onnx")
